...
from app.forms.binding_forms import UnbindForm  # 关键：从binding_forms导入UnbindForm
...
def purchased_products():
    ...
    # 实例化binding_forms中的UnbindForm（关键适配）
    form = UnbindForm()

    # 修改返回值：传递form变量到模板
    return render_template('purchased_products.html', trips=enriched_trips, form=form)